...
export class EvInventory__Params {
  ...
  get orderSalt(): BigInt {
    return this._event.parameters[3].value.toBigInt();
  }

  get settleSalt(): BigInt {
    return this._event.parameters[4].value.toBigInt();
  }
  ...
  get item(): EvInventoryItemStruct {
    return changetype<EvInventoryItemStruct>(
      this._event.parameters[10].value.toTuple()
    );
  }

  get detail(): EvInventoryDetailStruct {
    return changetype<EvInventoryDetailStruct>(
      this._event.parameters[11].value.toTuple()
    );
  }
}

export class EvInventoryItemStruct extends ethereum.Tuple {
  get price(): BigInt {
...
export class EvInventoryDetailStruct extends ethereum.Tuple {
  get op(): i32 {
    return this[0].toI32();
  }
  ...
  get fees(): Array<EvInventoryDetailFeesStruct> {
    return this[10].toTupleArray<EvInventoryDetailFeesStruct>();
  }
}

export class EvInventoryDetailFeesStruct extends ethereum.Tuple {
...
export class X2Y2_R1__ongoingAuctionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class X2Y2_R1__run1InputOrderStruct extends ethereum.Tuple {
  get salt(): BigInt {
    return this[0].toBigInt();
  }
  ...
  get items(): Array<X2Y2_R1__run1InputOrderItemsStruct> {
    return this[8].toTupleArray<X2Y2_R1__run1InputOrderItemsStruct>();
  }
...
export class X2Y2_R1__run1InputOrderItemsStruct extends ethereum.Tuple {
  get price(): BigInt {
    return this[0].toBigInt();
  }
...
export class X2Y2_R1__run1InputSharedStruct extends ethereum.Tuple {
  get salt(): BigInt {
    return this[0].toBigInt();
  }
...
export class X2Y2_R1__run1InputDetailStruct extends ethereum.Tuple {
  get op(): i32 {
    return this[0].toI32();
  }
  ...
  get fees(): Array<X2Y2_R1__run1InputDetailFeesStruct> {
    return this[10].toTupleArray<X2Y2_R1__run1InputDetailFeesStruct>();
  }
}

export class X2Y2_R1__run1InputDetailFeesStruct extends ethereum.Tuple {
  get percentage(): BigInt {
    return this[0].toBigInt();
  }
...
export class X2Y2_R1 extends ethereum.SmartContract {
  static bind(address: Address): X2Y2_R1 {
    return new X2Y2_R1("X2Y2_R1", address);
  }
  ...
  ongoingAuctions(param0: Bytes): X2Y2_R1__ongoingAuctionsResult {
    let result = super.call(
      "ongoingAuctions",
    ...
    return new X2Y2_R1__ongoingAuctionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress()
  ...
  try_ongoingAuctions(
    param0: Bytes
  ): ethereum.CallResult<X2Y2_R1__ongoingAuctionsResult> {
    let result = super.tryCall(
      "ongoingAuctions",
      "ongoingAuctions(bytes32):(uint256,uint256,uint256,address)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new X2Y2_R1__ongoingAuctionsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toAddress()
  ...
  run1(
    order: X2Y2_R1__run1InputOrderStruct,
    shared: X2Y2_R1__run1InputSharedStruct,
    detail: X2Y2_R1__run1InputDetailStruct
  ): BigInt {
    let result = super.call(
      "run1",
